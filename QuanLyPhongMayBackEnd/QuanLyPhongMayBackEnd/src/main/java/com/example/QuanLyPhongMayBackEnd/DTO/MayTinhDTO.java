...
public class MayTinhDTO {
    ...
    private Long maPhong;    // Added: ID of the room
    private String tenPhong;   // Added: Name of the room
    ...
    // --- Getters ---
    public Long getMaMay() { return maMay; }
    ...
    // --- Setters ---
    public void setMaMay(Long maMay) { this.maMay = maMay; }
    public void setTenMay(String tenMay) { this.tenMay = tenMay; }
    public void setTrangThai(String trangThai) { this.trangThai = trangThai; }
    public void setMoTa(String moTa) { this.moTa = moTa; }
    public void setNgayLapDat(Date ngayLapDat) { this.ngayLapDat = ngayLapDat; }
